...
# Бонусы
Параметр `desktopOnly` для хоткея позволяет использовать хоткей только на активном рабочем столе (т.е. можно иметь два окна браузера на двух разных рабочих столах и Win+B будет активировать только браузер на текущем рабочем столе).
